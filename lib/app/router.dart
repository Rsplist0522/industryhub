...
String? protectedRouteRedirect({
  ...
  if (protectedRoutePaths.contains(matchedLocation) &&
      !hasVerifiedSession) {
    return '/login';
  }
  return null;
      ...
      routes: [
        ...
        GoRoute(
          ...
          builder: (context, state) {
            final deal = state.extra is DealRequestRecord
                ? state.extra as DealRequestRecord
                : null;

            return FairPriceScreen(initialDeal: deal);
          },
        ),
        GoRoute(
