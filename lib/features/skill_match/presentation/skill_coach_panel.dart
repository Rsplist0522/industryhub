...
class _SkillCoachPanelState extends State<SkillCoachPanel> {
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        const SpecDivider(label: 'AI SKILL COACH / EVIDENCE-GROUNDED'),
        ...
        const Text(
          'The coach explains your calculated results and DOSM evidence. It cannot change scores or invent programmes. This conversation stays on this device for the current session.',
        ...
        if (widget.error != null) ...[
          ...
          Text(
            widget.error!,
            style: const TextStyle(color: AppColors.rust, fontSize: 12),
          ),
        ],
        const SizedBox(height: 10),
        Row(
  ...
  Widget build(BuildContext context) => Align(
    ...
    child: Container(
      ...
      decoration: BoxDecoration(
        color: message.isUser ? AppColors.navy : AppColors.white,
        border: Border.all(
          color: message.isUser ? AppColors.navy : AppColors.line,
        ),
      ...
      child: Column(
        ...
        children: [
          Text(
            message.text,
            style: TextStyle(
              color: message.isUser ? AppColors.white : AppColors.ink,
              height: 1.4,
            ),
          ),
